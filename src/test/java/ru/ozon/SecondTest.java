...
public class SecondTest {
    ...
    public void Step6() {
        try {
            driver.findElement(By.xpath("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[1]/aside/div[5]/div[2]/div/span[3]/label")).click();
            Thread.sleep(3000);
            Allure.addAttachment("carob", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
        } catch (Exception ex) {
            fail("Error: " + ex.getMessage());
        }
    }
    ...
    public void Step7() {
        try {
            driver.findElement(By.xpath("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[1]/aside/div[10]/div[2]/div/span[1]/label")).click();
            Thread.sleep(3000);
            driver.getKeyboard().pressKey(Keys.PAGE_UP);
            Allure.addAttachment("cups", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));;
        } catch (Exception ex) {
            fail("Error: " + ex.getMessage());
        }
    }
