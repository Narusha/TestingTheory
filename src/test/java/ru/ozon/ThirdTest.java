...
public class ThirdTest {
    ...
    public void Step8() {
        try {
            Thread.sleep(3000);
            driver.findElement(By.xpath("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[2]/div[3]/div[1]/div[1]/div/div[1]/div/div/div[3]/div[1]/div/div/button")).click();
            Thread.sleep(3000);
            Allure.addAttachment("favorites", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
            Thread.sleep(3000);
            Thread.sleep(3000);
            String productName = driver.findElementByXPath("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[2]/div[3]/div[1]/div[1]/div/div[1]/div/div/div[2]/div/a").getText();
            Thread.sleep(3000);
            driver.findElement(By.xpath("//*[@id=\"__ozon\"]/div/div[1]/header/div[1]/div[4]/a[1]")).click();
            Thread.sleep(3000);
            Allure.addAttachment("favorites2", new ByteArrayInputStream(((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES)));
            Thread.sleep(3000);
